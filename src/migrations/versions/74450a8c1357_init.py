...
Revision ID: 74450a8c1357
Revises: 
Create Date: 2024-03-16 13:32:39.956674
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['order_id'], ['item_options.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
